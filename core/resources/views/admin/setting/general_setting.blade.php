                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label class="form-control-label font-weight-bold">@lang('Auto Approve')</label>
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disabled')" name="auto_approve" @if($general->auto_approve) checked @endif>
                            </div>
                        </div>
