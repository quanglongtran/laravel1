            ...
            <div class="col-lg-6">
              <div class="account-content">
                <div class="text-center mb-5">
                  <h4 class="account-content__title">@lang('2FA Verification')</h4>
                </div>
                <form action="{{route('user.go2fa.verify')}}" method="POST" class="login-form">
                    @csrf
                  <div class="form-group">
                    <p class="text-center">@lang('Current Time'): <strong>{{\Carbon\Carbon::now()}}</strong></p>
                  </div>
                  <div class="form-group">
