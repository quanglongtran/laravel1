...
class TicketController extends Controller
{
    ...
    public function viewTicket($ticket)
    {
        ...
        $messages = SupportMessage::where('supportticket_id', $my_ticket->id)->orderBy('id','desc')->with('ticket')->get();
        $user = auth()->user();
        $extends = Auth::user() ? 'layouts.master' : 'layouts.frontend';
        $view = Auth::user() ? 'user.support.view' : 'contactView';

        return view($this->activeTemplate. $view, compact('my_ticket', 'messages', 'pageTitle', 'user', 'extends'));
